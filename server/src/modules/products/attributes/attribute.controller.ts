...
export class AttributeController {
  ...
  findAll(
    ...
    return this.attributeService.findAll({ page: query.page, limit: query.limit, search, isActive });
  }
  ...
  @Post(':id/values')
  @AdminAccess()
  addValue(@Param('id', ParseUUIDPipe) attributeId: string, @Body() dto: CreateAttributeValueDto) {
