      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-4">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="border-2 border-[#2d2d2d] p-4 flex gap-4 bg-white">
              <div className="h-20 w-20 bg-neutral-100 flex-shrink-0" />
        ...
        <div className="space-y-4">
          ...
          <div className="h-40 w-full border-2 border-[#2d2d2d] bg-white p-4 space-y-3">
