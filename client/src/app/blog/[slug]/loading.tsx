const Loading = () => {
  return (
    <div className="max-w-screen-lg mx-auto px-4 sm:px-6 md:px-8 py-6 bg-white min-h-screen">
      <div className="h-6 w-3/4 bg-[#2d2d2d]/10 mb-4" />
      <div className="h-3 w-1/3 bg-[#2d2d2d]/10 mb-6" />
      <div className="aspect-video w-full bg-neutral-100 mb-6 border-2 border-[#2d2d2d]">
