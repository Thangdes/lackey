const Loading = () => {
  return (
    <div className="max-w-screen-2xl mx-auto px-4 py-8 bg-[#f5f1e8] min-h-screen">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
          <div className="aspect-square w-full border-2 border-[#2d2d2d] bg-[#d4cfc0]">
          ...
          <div className="mt-4 grid grid-cols-4 gap-3">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="aspect-square w-full border-2 border-[#2d2d2d] bg-[#d4cfc0]" />
            ))}
          </div>
        </div>
      ...
      <div className="mt-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="border-2 border-[#2d2d2d] p-3 sm:p-4 bg-[#f5f1e8]">
              <div className="aspect-square w-full bg-[#d4cfc0]" />
