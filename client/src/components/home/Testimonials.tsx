...
const defaults: Testimonial[] = [
  {
    ...
    rating: 5,
    content: "Móc khóa thiết kế rất đẹp và độc đáo, giao hàng nhanh chóng và đóng gói vô cùng cẩn thận. Sản phẩm vượt ngoài mong đợi, chất lượng cao và thiết kế theo ý tưởng rất chính xác. Tôi chắc chắn sẽ tiếp tục ủng hộ dài dài!",
  },
  {
    id: "t2",
    name: "Thanh Bình",
    ...
    rating: 5,
    content: "Móc khóa thiết kế theo yêu cầu rất đẹp và chất lượng ổn định từ lần mua đầu đến giờ. Mẫu mã đa dạng, dễ dàng chọn lựa theo phong cách cá nhân. Giá cả so với thị trường cũng rất cạnh tranh, phù hợp làm quà tặng.",
  },
  {
    id: "t3",
    name: "Quỳnh Như",
    ...
    rating: 4,
    content: "Thiết kế móc khóa rất sáng tạo, dễ dàng kết hợp với nhiều phong cách khác nhau. Đặc biệt, dịch vụ tư vấn thiết kế rất hữu ích, giúp tôi có thêm nhiều ý tưởng mới lạ để chia sẻ với độc giả. Một lựa chọn đáng cân nhắc cho tín đồ phụ kiện.",
  },
  {
    id: "t4",
    name: "Hồng Phúc",
    ...
    rating: 5,
    content: "Tôi đã thử nhiều nơi bán móc khóa khác nhau, nhưng chỗ này thực sự nổi bật bởi thiết kế sáng tạo và chất lượng ổn định. Khách hàng của tôi thường khen móc khóa đẹp và bền hơn những nơi khác. Đây chắc chắn sẽ là nhà cung cấp lâu dài cho cửa hàng tôi.",
  },
];
