...
export default function ChristmasPopup() {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent 
        className="max-w-[96vw] sm:max-w-[600px] max-h-[90vh] p-0 overflow-hidden overflow-y-auto border-4 sm:border-8 border-double border-[#AE1C2C] bg-[#FFF8E7] shadow-2xl z-[999]"
      ...
      >
        ...
        <div className="relative">
          ...
          <DialogClose 
            className="absolute top-1 right-2 sm:top-2 sm:right-3 z-30 bg-[#AE1C2C] hover:bg-[#8B1623] text-white rounded-full p-1.5 sm:p-2 transition-all shadow-lg hover:scale-110"
            onClick={handleClose}
          >
            ...
            <div className="text-center space-y-3 sm:space-y-5">
              ...
              <div className="bg-white/80 backdrop-blur-sm p-3 sm:p-4 rounded-lg border-2 border-dashed border-[#AE1C2C]">
                ...
                <p className="text-xs sm:text-sm text-gray-600">
                  Áp dụng cho tất cả sản phẩm bàn phím cơ và phụ kiện.
                </p>
              </div>
